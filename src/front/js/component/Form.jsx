        ...
        <>
            <form className="row g-3 text-start" onSubmit={handleSubmit}>
                <div className="col-md-12">
                    <label htmlFor="nameAdd" className=" text-light form-label fw-semibold">Nombre</label>
                    <input 
                        value={data.name} 
                        name="name" 
                        type="text" 
                ...
                <div className="col-md-12">
                    <label htmlFor="emailAdd" className="text-light form-label fw-semibold">Correo Electrónico</label>
                    <input 
                        value={data.email} 
                        name="email" 
                        type="email" 
                ...
                <div className="col-md-12">
                    <label htmlFor="passAdd" className="text-light form-label fw-semibold">Contraseña</label>
                    <input 
                        value={data.password} 
                        name="password" 
                        type="password" 
                ...
                <div className="col-md-12">
                    <button type="submit" className=" text-light btn w-100 fw-semibold bg-success-subtle border border-black fw-bold">Registrate</button>
                </div>
            </form>
            {showAlert && (
                <div 
